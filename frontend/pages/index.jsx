...
import {
  KOKARTS_DAO_ABI,
  KOKARTS_DAO_CONTRACT_ADDRESS,
  KOKARTS_NFT_ABI,
  KOKARTS_NFT_CONTRACT_ADDRESS,
} from "../constants";
...
export default function Home() {
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any KOKARTS NFTs. <br />
  ...
  return (
    <div>
      <Head>
        <title>KOKARTS DAO</title>
        <meta name="description" content="KOKARTS DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to KOKARTS!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your KOKARTS NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <img className={styles.image} src="/kokarts/0.svg" />
        </div>
      </div>
